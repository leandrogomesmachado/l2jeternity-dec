...
public class ExceptionFactory {
   ...
   public static String createLinkFailureMessageBasedOnHeuristics(
      ...
      if (propertySet != null) {
         isInteractiveClient = propertySet.getBooleanProperty("interactiveClient").getValue();
      ...
      if (dueToTimeout != 1 && dueToTimeout != 2) {
         if (underlyingException instanceof BindException) {
            String localSocketAddress = propertySet.getStringProperty("localSocketAddress").getValue();
         ...
         if (lastPacketReceivedTimeMs != 0L) {
            Object[] timingInfo = new Object[]{timeSinceLastPacketReceivedMs, timeSinceLastPacketSentMs};
      ...
      if (exceptionMessageBuf.length() == 0) {
         ...
         if (propertySet.getBooleanProperty("maintainTimeStats").getValue() && !propertySet.getBooleanProperty("paranoid").getValue()) {
