...
public class IfStatement extends Statement {
   ...
   public FlowInfo analyseCode(BlockScope currentScope, FlowContext flowContext, FlowInfo flowInfo) {
      ...
      FlowInfo mergedInfo = FlowInfo.mergedOptimizedBranchesIfElse(
         thenFlowInfo, isConditionOptimizedTrue, elseFlowInfo, isConditionOptimizedFalse, true, flowInfo, this, reportDeadCodeForKnownPattern
      );
   ...
   public void generateCode(BlockScope currentScope, CodeStream codeStream) {
      if ((this.bits & -2147483648) != 0) {
         ...
         Constant cst;
         boolean hasThenPart = ((cst = this.condition.optimizedBooleanConstant()) == Constant.NotAConstant || cst.booleanValue())
         ...
         if (hasThenPart) {
            ...
            if (cst != Constant.NotAConstant && cst.booleanValue()) {
               ...
               this.condition
                  .generateOptimizedBoolean(currentScope, codeStream, null, hasElsePart ? (falseLabel = new BranchLabel(codeStream)) : endifLabel, true);
            }
