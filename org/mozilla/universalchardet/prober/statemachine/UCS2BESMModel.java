...
public class UCS2BESMModel extends SMModel {
   ...
   private static int[] ucs2beClassTable = new int[]{
      ...
      PkgInt.pack4bits(0, 0, 1, 0, 0, 2, 0, 0),
      PkgInt.pack4bits(0, 0, 0, 0, 0, 0, 0, 0),
      PkgInt.pack4bits(0, 0, 0, 3, 0, 0, 0, 0),
      PkgInt.pack4bits(0, 0, 0, 0, 0, 0, 0, 0),
      PkgInt.pack4bits(0, 3, 3, 3, 3, 3, 0, 0),
      PkgInt.pack4bits(0, 0, 0, 0, 0, 0, 0, 0),
      PkgInt.pack4bits(0, 0, 0, 0, 0, 0, 0, 0),
      PkgInt.pack4bits(0, 0, 0, 0, 0, 0, 0, 0),
      PkgInt.pack4bits(0, 0, 0, 0, 0, 0, 0, 0),
   ...
   private static int[] ucs2beStateTable = new int[]{
      PkgInt.pack4bits(5, 7, 7, 1, 4, 3, 1, 1),
      PkgInt.pack4bits(1, 1, 1, 1, 2, 2, 2, 2),
      PkgInt.pack4bits(2, 2, 6, 6, 6, 6, 1, 1),
      PkgInt.pack4bits(6, 6, 6, 6, 6, 2, 6, 6),
      PkgInt.pack4bits(6, 6, 6, 6, 5, 7, 7, 1),
      PkgInt.pack4bits(5, 8, 6, 6, 1, 6, 6, 6),
      PkgInt.pack4bits(6, 6, 6, 6, 1, 1, 0, 0)
   };
