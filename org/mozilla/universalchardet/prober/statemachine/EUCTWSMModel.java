...
public class EUCTWSMModel extends SMModel {
   ...
   private static int[] euctwStateTable = new int[]{
      PkgInt.pack4bits(1, 1, 0, 3, 3, 3, 4, 1),
      PkgInt.pack4bits(1, 1, 1, 1, 1, 1, 2, 2),
      PkgInt.pack4bits(2, 2, 2, 2, 2, 1, 0, 1),
      PkgInt.pack4bits(0, 0, 0, 1, 1, 1, 1, 1),
      PkgInt.pack4bits(5, 1, 1, 1, 0, 1, 0, 0),
      PkgInt.pack4bits(0, 1, 0, 0, 0, 0, 0, 0)
   };
