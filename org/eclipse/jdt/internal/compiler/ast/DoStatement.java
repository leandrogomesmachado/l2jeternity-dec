...
public class DoStatement extends Statement {
   ...
   public FlowInfo analyseCode(BlockScope currentScope, FlowContext flowContext, FlowInfo flowInfo) {
      ...
      FlowInfo condInfo = this.condition
         .analyseCode(
            currentScope,
      ...
      if (!isConditionOptimizedFalse && this.continueLabel != null) {
         ...
         loopingContext.complainOnDeferredNullChecks(
            currentScope, flowInfo.unconditionalCopy().addPotentialNullInfoFrom(condInfo.initsWhenTrue().unconditionalInits())
         );
         ...
         loopingContext.complainOnDeferredNullChecks(
            currentScope, flowInfo.unconditionalCopy().addPotentialNullInfoFrom(condInfo.initsWhenTrue().unconditionalInits()), false
         );
      ...
      if (loopingContext.hasEscapingExceptions()) {
         ...
         FlowInfo var16 = loopbackFlowInfo.mergedWith(loopbackFlowInfo.unconditionalCopy().addNullInfoFrom(condInfo.initsWhenTrue()).unconditionalInits());
         loopingContext.simulateThrowAfterLoopBack(var16);
      }
      ...
      FlowInfo mergedInfo = FlowInfo.mergedOptimizedBranches(
         ...
         (condInfo.tagBits & 3) == 0 ? flowInfo.copy().addInitializationsFrom(condInfo.initsWhenFalse()) : condInfo,
         false,
         !isConditionTrue
      );
