...
public final class InputStreamUtils {
   ...
   public static void attemptClose(InputStream var0, RobustMessageLogger var1) {
      try {
         var0.close();
      } catch (IOException var3) {
         if (var1 != null) {
            var1.log(var3, "IOException trying to close InputStream");
         }
      } catch (NullPointerException var4) {
         if (var1 != null) {
            var1.log(var4, "NullPointerException trying to close InputStream");
         }
      }
   }
