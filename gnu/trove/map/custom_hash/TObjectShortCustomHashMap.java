...
public class TObjectShortCustomHashMap<K> extends TCustomObjectHash<K> implements TObjectShortMap<K>, Externalizable {
   ...
   @Override
   public Set<K> keySet() {
      return new TObjectShortCustomHashMap.KeyView();
   }
   ...
   public TShortCollection valueCollection() {
      return new TObjectShortCustomHashMap.TShortValueCollection();
   }
   ...
   public TObjectShortIterator<K> iterator() {
      return new TObjectShortCustomHashMap.TObjectShortHashIterator<>(this);
   }
   ...
   class TShortValueCollection implements TShortCollection {
      ...
      public TShortIterator iterator() {
         return new TObjectShortCustomHashMap.TShortValueCollection.TObjectShortValueHashIterator();
      }
