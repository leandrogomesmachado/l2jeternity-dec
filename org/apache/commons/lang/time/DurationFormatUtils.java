...
public class DurationFormatUtils {
   ...
   static String format(
      DurationFormatUtils.Token[] tokens, int years, int months, int days, int hours, int minutes, int seconds, int milliseconds, boolean padWithZeros
   ) {
   ...
   static DurationFormatUtils.Token[] lexx(String format) {
      ...
      return list.toArray(new DurationFormatUtils.Token[list.size()]);
   }
