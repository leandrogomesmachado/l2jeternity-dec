...
public class _074_SagaOfTheDreadnoughts extends SagasSuperClass {
   public _074_SagaOfTheDreadnoughts(int id, String name, String descr) {
      super(id, name, descr);
      this.NPC = new int[]{30850, 31624, 31298, 31276, 31595, 31646, 31648, 31650, 31654, 31655, 31657, 31522};
      this.Items = new int[]{7080, 7538, 7081, 7489, 7272, 7303, 7334, 7365, 7396, 7427, 7097, 6480};
      this.Mob = new int[]{27290, 27223, 27282};
      this.classid = new int[]{89};
      this.prevclass = new int[]{3};
