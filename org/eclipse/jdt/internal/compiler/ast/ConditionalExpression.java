...
public class ConditionalExpression extends OperatorExpression implements IPolyExpression {
   ...
   public void generateOptimizedBoolean(BlockScope currentScope, CodeStream codeStream, BranchLabel trueLabel, BranchLabel falseLabel, boolean valueRequired) {
      ...
      if ((this.constant == Constant.NotAConstant || this.constant.typeID() != 5)
         && (this.valueIfTrue.implicitConversion & 0xFF) >> 4 == 5
         && (this.valueIfFalse.implicitConversion & 0xFF) >> 4 == 5) {
   ...
   public TypeBinding resolveType(BlockScope scope) {
      ...
      if (this.use18specifics
         && (this.expressionContext == ExpressionContext.ASSIGNMENT_CONTEXT || this.expressionContext == ExpressionContext.INVOCATION_CONTEXT)) {
      ...
      if (!this.isPolyExpression()) {
         ...
         if (this.condition.constant != Constant.NotAConstant) {
            Constant trueConstant = this.valueIfTrue.constant;
            if (this.valueIfTrue.constant != Constant.NotAConstant) {
               Constant falseConstant = this.valueIfFalse.constant;
               if (this.valueIfFalse.constant != Constant.NotAConstant) {
         ...
         if (TypeBinding.equalsEquals(valueIfTrueType, valueIfFalseType)) {
            ...
            if (TypeBinding.equalsEquals(valueIfTrueType, TypeBinding.BYTE) && TypeBinding.equalsEquals(valueIfFalseType, TypeBinding.SHORT)
               ...
               return this.resolvedType = TypeBinding.SHORT;
                  ...
                  TypeBinding.equalsEquals(valueIfTrueType, TypeBinding.BYTE)
         ...
         return (TypeBinding)(this.expectedType != null && this.expectedType.isProperType(true)
            ? (this.resolvedType = this.computeConversions(scope, this.expectedType) ? this.expectedType : null)
            : new PolyTypeBinding(this));
      }
   }
   ...
   public boolean isPolyExpression() throws UnsupportedOperationException {
      if (!this.use18specifics) {
         ...
         return false;
      } else if (!this.valueIfTrue.isPolyExpression() && !this.valueIfFalse.isPolyExpression()) {
         return !this.originalValueIfTrueType.isBaseType() && (this.originalValueIfTrueType.id < 26 || this.originalValueIfTrueType.id > 33)
               || !this.originalValueIfFalseType.isBaseType() && (this.originalValueIfFalseType.id < 26 || this.originalValueIfFalseType.id > 33)
   ...
   public boolean isCompatibleWith(TypeBinding left, Scope scope) {
      return this.isPolyExpression()
         ? this.valueIfTrue.isCompatibleWith(left, scope) && this.valueIfFalse.isCompatibleWith(left, scope)
   ...
   public boolean isBoxingCompatibleWith(TypeBinding targetType, Scope scope) {
      return this.isPolyExpression()
         ? (this.valueIfTrue.isCompatibleWith(targetType, scope) || this.valueIfTrue.isBoxingCompatibleWith(targetType, scope))
            && (this.valueIfFalse.isCompatibleWith(targetType, scope) || this.valueIfFalse.isBoxingCompatibleWith(targetType, scope))
