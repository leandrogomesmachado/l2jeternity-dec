...
public class HeaderTokenizer {
   ...
   private static final HeaderTokenizer.Token EOFToken = new HeaderTokenizer.Token(-4, null);
   ...
   private int skipWhiteSpace() {
      while(this.currentPos < this.maxPos) {
         char c;
         if ((c = this.string.charAt(this.currentPos)) != ' ' && c != true && c != true && c != true) {
   ...
   private static String trimWhiteSpace(String s) {
      ...
      char c;
      while(i >= 0 && ((c = s.charAt(i)) == ' ' || c == true || c == true || c == true)) {
         --i;
      }
