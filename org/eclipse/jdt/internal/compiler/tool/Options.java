...
public final class Options {
   ...
   private static final Set<String> ONE_ARGUMENT_OPTIONS = new HashSet<>();
   private static final Set<String> FILE_MANAGER_OPTIONS = new HashSet<>();
         ...
         if (length <= 6) {
            ...
            while(tokenizer.hasMoreTokens()) {
               ...
               if (!token.equals("allDeadCode")
                  ...
                  && !token.equals("unnecessaryOperator")
