...
public class CallableStatement extends ClientPreparedStatement implements java.sql.CallableStatement {
   ...
   public CallableStatement(JdbcConnection conn, CallableStatement.CallableStatementParamInfo paramInfo) throws SQLException {
      ...
      this.noAccessToProcedureBodies = conn.getPropertySet().getBooleanProperty("noAccessToProcedureBodies").getValue();
   }
         ...
         synchronized(this.checkClosed().getConnectionMutex()) {
            if (this.noAccessToProcedureBodies) {
               ...
               if (this.paramInfo != null && (namedParamInfo = this.paramInfo.getParameter(paramName)) != null) {
                  ...
                  throw SQLError.createSQLException(
                     Messages.getString("CallableStatement.3", new Object[]{paramName}), "S1009", this.getExceptionInterceptor()
                  );
               }
            } else {
                        ...
                        if (((PreparedQuery)this.query).getQueryBindings().getBindValues()[inParamInfo.index].isNull()) {
                           ...
                           if (parameterAsBytes != null) {
                              if (parameterAsBytes.length > 8
                                 && parameterAsBytes[0] == 95
                                 && parameterAsBytes[1] == 98
                                 && parameterAsBytes[2] == 105
                                 && parameterAsBytes[3] == 110
                                 && parameterAsBytes[4] == 97
                                 && parameterAsBytes[5] == 114
                                 && parameterAsBytes[6] == 121
                                 && parameterAsBytes[7] == 39) {
   ...
   public class CallableStatementParamInfo implements ParameterMetaData {
      ...
      public String getParameterClassName(int arg0) throws SQLException {
         try {
            ...
            switch(mysqlType) {
               case YEAR:
                  if (!CallableStatement.this.session.getPropertySet().getBooleanProperty("yearIsDateType").getValue()) {
