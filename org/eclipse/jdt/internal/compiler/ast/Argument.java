...
public class Argument extends LocalDeclaration {
   ...
   public TypeBinding bind(MethodScope scope, TypeBinding typeBinding, boolean used) {
      ...
      if (existingVariable != null && existingVariable.isValidBinding()) {
         ...
         } else if ((this.bits & 2097152) != 0 && scope.isLambdaSubscope()) {
   ...
   public TypeBinding resolveForCatch(BlockScope scope) {
      ...
      if (scope.compilerOptions().isAnnotationBasedNullAnalysisEnabled
         && (this.type.hasNullTypeAnnotation(TypeReference.AnnotationPosition.ANY) || TypeReference.containsNullAnnotation(this.annotations))) {
