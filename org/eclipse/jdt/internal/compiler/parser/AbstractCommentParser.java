...
public abstract class AbstractCommentParser implements JavadocTagConstants {
   ...
   protected Object parseArguments(Object receiver) throws InvalidInputException {
      ...
      while(this.index < this.scanner.eofPosition) {
         ...
         if (firstArg ? iToken != 0 : iToken % modulo != 0) {
            break;
         }
         ...
         if (typeRef == null) {
            ...
            if (this.readToken() == 22) {
               this.consumeToken();
               if ((firstArg ? iToken != 1 : iToken % modulo != 1) || argName == null && !firstArg) {
                  break;
               }
            ...
            if (token == 33) {
               Object argument = this.createArgumentReference(name, dim, isVarargs, typeRef, dimPositions, argNamePos);
               if (this.abort) {
                  return null;
               }
      ...
      try {
         ...
         if (currentChar == 'a' || currentChar == 'A') {
            ...
            if (this.readToken() == 22) {
               ...
               try {
                  if (CharOperation.equals(this.scanner.getCurrentIdentifierSource(), HREF_TAG, false) && this.readToken() == 70) {
                     this.consumeToken();
                  ...
                  label517: {
                     label518: {
                        ...
                        if (this.reportProblems) {
                           ...
                           try {
                              while((token = this.readToken()) != 1000 && token != 60) {
                                 this.currentTokenType = -1;
                                 end = hasMultiLines ? this.lineEnd : this.scanner.getCurrentTokenEndPosition();
                              }
                  ...
                  if (currentError.length > 0 && currentError[0] == '"') {
                     if (this.reportProblems) {
                        ...
                        if (isUrlRef) {
                           this.sourceParser
                              .problemReporter()
                              .javadocInvalidSeeUrlReference(this.scanner.getCurrentTokenStartPosition(), this.getTokenEndPosition());
                        } else {
                           this.sourceParser
                              .problemReporter()
                              .javadocInvalidReference(this.scanner.getCurrentTokenStartPosition(), this.getTokenEndPosition());
                        }
                     }
                     ...
                     if (this.reportProblems) {
                        this.sourceParser
                           ...
                           .javadocMissingHashCharacter(
                              typeRefStartPosition, this.lineEnd, String.valueOf(this.source, typeRefStartPosition, this.lineEnd - typeRefStartPosition + 1)
                           );
                     }
   ...
   protected char peekChar() {
      ...
      if (c == '\\' && this.source[idx] == 'u') {
         ...
         int c3;
         int c4;
         if ((c1 = ScannerHelper.getHexadecimalValue(this.source[idx++])) <= 15
            && c1 >= 0
            && (c2 = ScannerHelper.getHexadecimalValue(this.source[idx++])) <= 15
            && c2 >= 0
            && (c3 = ScannerHelper.getHexadecimalValue(this.source[idx++])) <= 15
            && c3 >= 0
            && (c4 = ScannerHelper.getHexadecimalValue(this.source[idx++])) <= 15
            && c4 >= 0) {
