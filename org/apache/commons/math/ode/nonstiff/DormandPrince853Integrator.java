...
public class DormandPrince853Integrator extends EmbeddedRungeKuttaIntegrator {
   ...
   private static final double[][] STATIC_A = new double[][]{
      ...
      {0.037037037037037035, 0.0, 0.0, (16.0 + FastMath.sqrt(6.0)) / 108.0, (16.0 - FastMath.sqrt(6.0)) / 108.0},
      {0.037109375, 0.0, 0.0, (118.0 + 23.0 * FastMath.sqrt(6.0)) / 1024.0, (118.0 - 23.0 * FastMath.sqrt(6.0)) / 1024.0, -0.017578125},
      {
            0.03709200011850479,
            0.0,
            0.0,
      ...
      },
      {
            ...
            0.0,
            0.0,
            (-1.324889724104E12 - 3.18801444819E11 * FastMath.sqrt(6.0)) / 6.265569375E11,
            (-1.324889724104E12 + 3.18801444819E11 * FastMath.sqrt(6.0)) / 6.265569375E11,
            27.59209969944671,
            20.154067550477894,
            -43.48988418106996
   ...
   private static final double[] STATIC_B = new double[]{
      0.054293734116568765,
      0.0,
      0.0,
      0.0,
   ...
   protected double estimateError(double[][] yDotK, double[] y0, double[] y1, double h) {
      ...
      for(int j = 0; j < this.mainSetDimension; ++j) {
         double errSum1 = 0.01312004499419488 * yDotK[0][j]
            + -1.2251564463762044 * yDotK[5][j]
            + -0.4957589496572502 * yDotK[6][j]
            + 1.6643771824549864 * yDotK[7][j]
            + -0.35032884874997366 * yDotK[8][j]
            + 0.3341791187130175 * yDotK[9][j]
            + 0.08192320648511571 * yDotK[10][j]
            + -0.022355307863886294 * yDotK[11][j];
         double errSum2 = -0.18980075407240762 * yDotK[0][j]
            + 4.450312892752409 * yDotK[5][j]
            + 1.8915178993145003 * yDotK[6][j]
            + -5.801203960010585 * yDotK[7][j]
            + -0.42268232132379197 * yDotK[8][j]
            + -0.1521609496625161 * yDotK[9][j]
            + 0.20136540080403034 * yDotK[10][j]
            + 0.022651792198360825 * yDotK[11][j];
