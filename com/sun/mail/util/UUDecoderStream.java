            ...
            if (line.length() != 0) {
               ...
               if (var6 < 32) {
                  ...
                  if (line.length() >= need + 1) {
                     ...
                     while(this.bufsize < var6) {
                        byte a = (byte)(line.charAt(need++) - ' ' & 63);
                        byte b = (byte)(line.charAt(need++) - ' ' & 63);
                        this.buffer[this.bufsize++] = (byte)(a << 2 & 252 | b >>> 4 & 3);
                        if (this.bufsize < var6) {
                           a = b;
                           b = (byte)(line.charAt(need++) - ' ' & 63);
                           this.buffer[this.bufsize++] = (byte)(a << 4 & 240 | b >>> 2 & 15);
                        }

                        if (this.bufsize < var6) {
                           byte var13 = (byte)(line.charAt(need++) - ' ' & 63);
