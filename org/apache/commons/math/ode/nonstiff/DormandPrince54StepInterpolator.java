   ...
   protected void computeInterpolatedStateAndDerivatives(double theta, double oneMinusThetaH) throws DerivativeException {
      if (!this.vectorsInitialized) {
         ...
         for(int i = 0; i < this.interpolatedState.length; ++i) {
            ...
            this.v1[i] = 0.09114583333333333 * yDot0
               + 0.44923629829290207 * yDot2
               + 0.6510416666666666 * yDot3
               + -0.322376179245283 * yDot4
               + 0.13095238095238096 * yDot5;
            this.v2[i] = yDot0 - this.v1[i];
            this.v3[i] = this.v1[i] - this.v2[i] - yDot6;
            this.v4[i] = -1.1270175653862835 * yDot0
               + 2.675424484351598 * yDot2
               + -5.685526961588504 * yDot3
               + 3.5219323679207912 * yDot4
               + -1.7672812570757455 * yDot5
               + 2.382468931778144 * yDot6;
         }
