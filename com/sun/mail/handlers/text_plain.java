      ...
      try {
         ...
         while((count = is.read(buf, pos, buf.length - pos)) != -1) {
            ...
            if (pos >= buf.length) {
               ...
               char[] tbuf = new char[var20];
               System.arraycopy(buf, 0, tbuf, 0, pos);
               buf = tbuf;
            }
         }

         var21 = new String(buf, 0, pos);
      } finally {
         try {
            is.close();
   ...
   public void writeTo(Object obj, String type, OutputStream os) throws IOException {
      if (!(obj instanceof String)) {
         throw new IOException(
            "\"" + this.getDF().getMimeType() + "\" DataContentHandler requires String object, " + "was given object of type " + obj.getClass().toString()
         );
      } else {
         String enc = null;
