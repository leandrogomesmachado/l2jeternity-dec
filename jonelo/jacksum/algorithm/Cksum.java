...
public class Cksum extends AbstractChecksum {
   protected int value;
   protected final int[] crctab = new int[]{
      0,
      79764919,
      159529838,
      222504665,
   ...
   public void update(byte var1) {
      this.value = this.value << 8 ^ this.crctab[(this.value >> 24 ^ var1) & 0xFF];
      ++this.length;
   }
   ...
   public long getValue() {
      ...
      int var3;
      for(var3 = this.value; var1 != 0L; var1 >>= 8) {
         var3 = var3 << 8 ^ this.crctab[(var3 >> 24 ^ (int)(var1 & 255L)) & 0xFF];
      }

      return (long)(~var3) & 4294967295L;
   }
