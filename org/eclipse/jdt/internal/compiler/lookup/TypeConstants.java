...
public interface TypeConstants {
   ...
   char[][] JAVA_LANG_INVOKE_METHODHANDLE_POLYMORPHICSIGNATURE = new char[][]{
      JAVA, LANG, INVOKE, "MethodHandle".toCharArray(), "PolymorphicSignature".toCharArray()
   };
   ...
   TypeConstants.CloseMethodRecord[] closeMethods = new TypeConstants.CloseMethodRecord[]{
      new TypeConstants.CloseMethodRecord(GUAVA_CLOSEABLES, CLOSE_QUIETLY, 1),
      new TypeConstants.CloseMethodRecord(GUAVA_CLOSEABLES, CLOSE, 1),
      new TypeConstants.CloseMethodRecord(APACHE_IOUTILS, CLOSE_QUIETLY, 1),
      new TypeConstants.CloseMethodRecord(APACHE_DBUTILS, CLOSE, 1),
      new TypeConstants.CloseMethodRecord(APACHE_DBUTILS, CLOSE_QUIETLY, 3),
      new TypeConstants.CloseMethodRecord(APACHE_DBUTILS, "commitAndClose".toCharArray(), 1),
      new TypeConstants.CloseMethodRecord(APACHE_DBUTILS, "commitAndCloseQuietly".toCharArray(), 1),
      new TypeConstants.CloseMethodRecord(APACHE_DBUTILS, "rollbackAndClose".toCharArray(), 1),
      new TypeConstants.CloseMethodRecord(APACHE_DBUTILS, "rollbackAndCloseQuietly".toCharArray(), 1)
   };
   char[][] JAVA_IO_WRAPPER_CLOSEABLES = new char[][]{
      "BufferedInputStream".toCharArray(),
      "BufferedOutputStream".toCharArray(),
      "BufferedReader".toCharArray(),
      "BufferedWriter".toCharArray(),
      "InputStreamReader".toCharArray(),
      "PrintWriter".toCharArray(),
      "LineNumberReader".toCharArray(),
      "DataInputStream".toCharArray(),
      "DataOutputStream".toCharArray(),
      "ObjectInputStream".toCharArray(),
      "ObjectOutputStream".toCharArray(),
      "FilterInputStream".toCharArray(),
      "FilterOutputStream".toCharArray(),
      "DataInputStream".toCharArray(),
      "DataOutputStream".toCharArray(),
      "PushbackInputStream".toCharArray(),
      "SequenceInputStream".toCharArray(),
      "PrintStream".toCharArray(),
      "PushbackReader".toCharArray(),
      "OutputStreamWriter".toCharArray()
   };
   char[][] JAVA_UTIL_ZIP_WRAPPER_CLOSEABLES = new char[][]{
      "GZIPInputStream".toCharArray(),
      "InflaterInputStream".toCharArray(),
      "DeflaterInputStream".toCharArray(),
      "CheckedInputStream".toCharArray(),
      "ZipInputStream".toCharArray(),
      "JarInputStream".toCharArray(),
      "GZIPOutputStream".toCharArray(),
      "InflaterOutputStream".toCharArray(),
      "DeflaterOutputStream".toCharArray(),
      "CheckedOutputStream".toCharArray(),
      "ZipOutputStream".toCharArray(),
      "JarOutputStream".toCharArray()
   };
   char[][][] OTHER_WRAPPER_CLOSEABLES = new char[][][]{
      {JAVA, "security".toCharArray(), "DigestInputStream".toCharArray()},
      {JAVA, "security".toCharArray(), "DigestOutputStream".toCharArray()},
      {JAVA, "beans".toCharArray(), "XMLEncoder".toCharArray()},
      {JAVA, "beans".toCharArray(), "XMLDecoder".toCharArray()},
      {JAVAX, "sound".toCharArray(), "sampled".toCharArray(), "AudioInputStream".toCharArray()}
   };
   char[][] JAVA_IO_RESOURCE_FREE_CLOSEABLES = new char[][]{
      "StringReader".toCharArray(),
      "StringWriter".toCharArray(),
      "ByteArrayInputStream".toCharArray(),
      "ByteArrayOutputStream".toCharArray(),
      "CharArrayReader".toCharArray(),
      "CharArrayWriter".toCharArray(),
      "StringBufferInputStream".toCharArray()
   };
   char[][] RESOURCE_FREE_CLOSEABLE_STREAM = new char[][]{JAVA, UTIL, "stream".toCharArray(), "Stream".toCharArray()};
   ...
   public static enum BoundCheckStatus {
      ...
      public TypeConstants.BoundCheckStatus betterOf(TypeConstants.BoundCheckStatus other) {
