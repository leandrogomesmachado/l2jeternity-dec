...
public class LongPropertyDefinition extends AbstractPropertyDefinition<Long> {
   ...
   public LongPropertyDefinition(
      String name, String alias, long defaultValue, boolean isRuntimeModifiable, String description, String sinceVersion, String category, int orderInCategory
   ) {
   ...
   public LongPropertyDefinition(
      ...
      super(name, alias, defaultValue, isRuntimeModifiable, description, sinceVersion, category, orderInCategory, (int)lowerBound, (int)upperBound);
   }
