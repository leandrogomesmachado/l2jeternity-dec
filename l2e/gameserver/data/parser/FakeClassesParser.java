...
public class FakeClassesParser {
   private static Logger _log = Logger.getLogger(FakeClassesParser.class.getName());
   ...
   public void load() {
      ...
      _log.info(
         this.getClass().getSimpleName()
            + ": Loaded "
            + (_baseClasses.size() + _firstClasses.size() + _secondClasses.size() + _thirdClasses.size())
            + " fake classes."
      );
   }
   ...
   public static FakeClassesParser getInstance() {
      return FakeClassesParser.SingletonHolder._instance;
   }
