...
public class GB18030SMModel extends SMModel {
   ...
   private static int[] gb18030StateTable = new int[]{
      PkgInt.pack4bits(1, 0, 0, 0, 0, 0, 3, 1),
      PkgInt.pack4bits(1, 1, 1, 1, 1, 1, 2, 2),
      PkgInt.pack4bits(2, 2, 2, 2, 2, 1, 1, 0),
      PkgInt.pack4bits(4, 1, 0, 0, 1, 1, 1, 1),
      PkgInt.pack4bits(1, 1, 5, 1, 1, 1, 2, 1),
      PkgInt.pack4bits(1, 1, 0, 0, 0, 0, 0, 0)
   };
