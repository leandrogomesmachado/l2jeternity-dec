...
public class TObjectIntHashMap<K> extends TObjectHash<K> implements TObjectIntMap<K>, Externalizable {
   ...
   @Override
   public Set<K> keySet() {
      return new TObjectIntHashMap.KeyView();
   }
   ...
   public TIntCollection valueCollection() {
      return new TObjectIntHashMap.TIntValueCollection();
   }
   ...
   public TObjectIntIterator<K> iterator() {
      return new TObjectIntHashMap.TObjectIntHashIterator<>(this);
   }
   ...
   class TIntValueCollection implements TIntCollection {
      ...
      public TIntIterator iterator() {
         return new TObjectIntHashMap.TIntValueCollection.TObjectIntValueHashIterator();
      }
