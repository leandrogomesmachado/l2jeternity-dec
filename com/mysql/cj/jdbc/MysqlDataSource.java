...
public class MysqlDataSource extends JdbcPropertySetImpl implements DataSource, Referenceable, Serializable, JdbcPropertySet {
   ...
   public Connection getConnection(String userID, String pass) throws SQLException {
      try {
         ...
         if (userID != null) {
            props.setProperty(PropertyDefinitions.PropertyKey.USER.getKeyName(), userID);
         }

         if (pass != null) {
            props.setProperty(PropertyDefinitions.PropertyKey.PASSWORD.getKeyName(), pass);
         }
   ...
   public Reference getReference() throws NamingException {
      ...
      ref.add(new StringRefAddr(PropertyDefinitions.PropertyKey.USER.getKeyName(), this.getUser()));
      ref.add(new StringRefAddr(PropertyDefinitions.PropertyKey.PASSWORD.getKeyName(), this.password));
      ...
      for(String propName : PropertyDefinitions.PROPERTY_NAME_TO_PROPERTY_DEFINITION.keySet()) {
         RuntimeProperty<?> propToStore = this.getProperty(propName);
   ...
   protected Connection getConnection(Properties props) throws SQLException {
      ...
      urlProps.remove(PropertyDefinitions.PropertyKey.HOST.getKeyName());
      urlProps.remove(PropertyDefinitions.PropertyKey.PORT.getKeyName());
      urlProps.remove(PropertyDefinitions.PropertyKey.DBNAME.getKeyName());
   ...
   public void setXdevapiUseAsyncProtocol(boolean var1) throws SQLException {
      this.setBooleanRuntimeProperty("xdevapiUseAsyncProtocol", var1);
   }
   ...
   public void setXdevapiSSLTruststorePassword(String var1) throws SQLException {
      this.setStringRuntimeProperty("xdevapiSSLTruststorePassword", var1);
   }
   ...
   public void setXdevapiSSLMode(String var1) throws SQLException {
      this.setEnumRuntimeProperty("xdevapiSSLMode", var1);
   }
   ...
   public void setXdevapiSSLTruststore(String var1) throws SQLException {
      this.setStringRuntimeProperty("xdevapiSSLTruststore", var1);
   }
   ...
   public void setXdevapiAuth(String var1) throws SQLException {
      this.setEnumRuntimeProperty("xdevapiAuth", var1);
   }
   ...
   public void setXdevapiAsyncResponseTimeout(int var1) throws SQLException {
      this.setIntegerRuntimeProperty("xdevapiAsyncResponseTimeout", var1);
   }
   ...
   public boolean getUseOldUTF8Behavior() throws SQLException {
      return this.getBooleanRuntimeProperty("useOldUTF8Behavior");
   }

   public void setUseOldUTF8Behavior(boolean var1) throws SQLException {
      this.setBooleanRuntimeProperty("useOldUTF8Behavior", var1);
   }
   ...
   public void setXdevapiSSLTruststoreType(String var1) throws SQLException {
      this.setStringRuntimeProperty("xdevapiSSLTruststoreType", var1);
   }
