...
public abstract class ClassFileStruct {
   ...
   public int i4At(int relativeOffset) {
      ...
      return (this.reference[position++] & 0xFF) << 24
         | (this.reference[position++] & 0xFF) << 16
         | ((this.reference[position++] & 0xFF) << 8) + (this.reference[position] & 0xFF);
   }

   public long i8At(int relativeOffset) {
      int position = relativeOffset + this.structOffset;
      return (long)(this.reference[position++] & 255) << 56
         | (long)(this.reference[position++] & 255) << 48
         | (long)(this.reference[position++] & 255) << 40
         | (long)(this.reference[position++] & 255) << 32
         | (long)(this.reference[position++] & 255) << 24
         | (long)(this.reference[position++] & 255) << 16
         | (long)(this.reference[position++] & 255) << 8
         | (long)(this.reference[position++] & 255);
   }
   ...
   public long u4At(int relativeOffset) {
      int position = relativeOffset + this.structOffset;
      return ((long)this.reference[position++] & 255L) << 24
         | (long)((this.reference[position++] & 255) << 16)
         | (long)((this.reference[position++] & 255) << 8)
         | (long)(this.reference[position] & 255);
   }
