...
public class _426_FishingShot extends Quest {
   ...
   public _426_FishingShot(int questId, String name, String descr) {
      ...
      for(int npc : new int[]{31616, 31696, 31697, 32348, 31989, 32007, 32348}) {
      ...
      this.questItemIds = new int[]{7586};
   }
   ...
   public final String onTalk(Npc npc, Player player) {
      ...
      QuestState st = player.getQuestState("_426_FishingShot");
      if (st == null) {
         return htmltext;
      } else {
         switch(st.getState()) {
            case 0:
               ...
               break;
            case 1:
               if (st.getQuestItemsCount(7586) > 0L) {
                  htmltext = "04.htm";
               } else {
                  htmltext = "03.htm";
               }
   ...
   public final String onKill(Npc npc, Player player, boolean isSummon) {
      ...
      if (partyMember == null) {
         ...
         QuestState st = partyMember.getQuestState("_426_FishingShot");
         int npcId = npc.getId();
         int drop = 0;
         int chance = 0;
   ...
   public static void main(String[] args) {
      new _426_FishingShot(426, "_426_FishingShot", "");
   }
   ...
   static {
      ...
      MOBS5.put(21654, 400);
      MOBS5.put(21656, 750);
      MOBSspecial.put(20829, new int[]{115, 6});
      MOBSspecial.put(20859, new int[]{890, 8});
      MOBSspecial.put(21066, new int[]{5, 5});
      MOBSspecial.put(21068, new int[]{565, 11});
      MOBSspecial.put(21071, new int[]{400, 12});
