      ...
      switch(cond) {
         ...
         case 1:
            ...
            message.replaceNpcString(
               "%password%",
               this._index == 0
                  ? NpcStringId.THE_MARKS_HAVE_NOT_BEEN_ASSEMBLED
                  : (this._index == 1 ? NpcStringId.THE_1ST_MARK_IS_CORRECT : NpcStringId.THE_2ND_MARK_IS_CORRECT)
            );
         ...
         case 2:
            ...
            this.getFort().getSiege().killedControlUnit(this);
            this.onDecay();
            break;
         case 3:
