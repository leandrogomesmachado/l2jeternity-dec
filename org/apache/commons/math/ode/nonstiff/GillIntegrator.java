...
public class GillIntegrator extends RungeKuttaIntegrator {
   ...
   private static final double[][] STATIC_A = new double[][]{
      {0.5}, {(FastMath.sqrt(2.0) - 1.0) / 2.0, (2.0 - FastMath.sqrt(2.0)) / 2.0}, {0.0, -FastMath.sqrt(2.0) / 2.0, (2.0 + FastMath.sqrt(2.0)) / 2.0}
   };
   private static final double[] STATIC_B = new double[]{
      0.16666666666666666, (2.0 - FastMath.sqrt(2.0)) / 6.0, (2.0 + FastMath.sqrt(2.0)) / 6.0, 0.16666666666666666
   };
