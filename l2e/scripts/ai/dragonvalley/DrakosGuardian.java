...
public class DrakosGuardian extends Fighter {
   ...
   protected void onEvtSpawn() {
      ...
      if (actor != null) {
         ...
         if (((MonsterInstance)actor).isCanSupportMinion()) {
            int amount = actor.getTemplate().getParameter("minionsAmount", 0);
            actor.getMinionList().addMinion(new MinionData(new MinionTemplate(22824, amount)), true);
         }
