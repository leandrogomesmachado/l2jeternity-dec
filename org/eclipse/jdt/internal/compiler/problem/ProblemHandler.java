...
public class ProblemHandler {
   ...
   public CategorizedProblem createProblem(
      ...
      return this.problemFactory
         .createProblem(fileName, problemId, problemArguments, messageArguments, severity, problemStartPosition, problemEndPosition, lineNumber, columnNumber);
   }
         ...
         if ((severity & 512) == 0 && this.policy.ignoreAllErrors()) {
            ...
            if (referenceContext == null) {
               ...
               int columnNumber = problemStartPosition >= 0
                  ...
                  : 0;
               CategorizedProblem problem = this.createProblem(
   ...
   public void handle(
      ...
      this.handle(
         ...
         0,
         messageArguments,
         this.computeSeverity(problemId),
         problemStartPosition,
         problemEndPosition,
         referenceContext,
         unitResult
