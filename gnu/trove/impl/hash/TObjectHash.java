...
public abstract class TObjectHash<T> extends THash {
   ...
   protected int index(Object obj) {
      if (obj == null) {
         ...
         if (cur == FREE) {
            ...
            return cur != obj && !this.equals(obj, cur) ? this.indexRehashed(obj, index, hash, cur) : index;
         }
      }
   }
   ...
   protected int insertKey(T key) {
      ...
      if (key == null) {
         ...
         if (cur == FREE) {
            ...
            return cur != key && !this.equals(key, cur) ? this.insertKeyRehash(key, index, hash, cur) : -index - 1;
         }
      }
   }
   ...
   protected boolean equals(Object notnull, Object two) {
      return two != null && two != REMOVED ? notnull.equals(two) : false;
   }
   ...
   protected static String objectInfo(Object o) {
      return (o == null ? "class null" : o.getClass())
         + " id= "
