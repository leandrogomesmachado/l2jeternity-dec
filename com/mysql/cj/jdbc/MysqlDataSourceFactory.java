...
public class MysqlDataSourceFactory implements ObjectFactory {
   ...
   public Object getObjectInstance(Object refObj, Name nm, Context ctx, Hashtable<?, ?> env) throws Exception {
      ...
      if (className != null
         ...
         String user = this.nullSafeRefAddrStringGet(PropertyDefinitions.PropertyKey.USER.getKeyName(), ref);
         if (user != null) {
            dataSource.setUser(user);
         }

         String password = this.nullSafeRefAddrStringGet(PropertyDefinitions.PropertyKey.PASSWORD.getKeyName(), ref);
         if (password != null) {
