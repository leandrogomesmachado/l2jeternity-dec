...
public class JDTCompilerAdapter extends DefaultCompilerAdapter {
   ...
   public boolean execute() throws BuildException {
      ...
      try {
         ...
         Object batchCompilerInstance = batchCompilerConstructor.newInstance(
            new PrintWriter(System.out), new PrintWriter(System.err), Boolean.TRUE, this.customDefaultOptions
         );
