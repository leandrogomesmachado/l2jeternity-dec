...
public interface QueryBindings<T extends BindValue> {
   ...
   void setValue(int var1, byte[] var2);
   ...
   void setDate(int var1, Date var2, TimeZone var3);
   ...
   void setTime(int var1, Time var2, TimeZone var3);

   void setTimestamp(int var1, Timestamp var2, Calendar var3);

   void setTimestamp(int var1, Timestamp var2);

   void setTimestamp(int var1, Timestamp var2, TimeZone var3);
}
