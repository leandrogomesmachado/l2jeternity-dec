...
public class HZSMModel extends SMModel {
   ...
   private static int[] hzsStateTable = new int[]{
      PkgInt.pack4bits(0, 1, 3, 0, 0, 0, 1, 1),
      PkgInt.pack4bits(1, 1, 1, 1, 2, 2, 2, 2),
      PkgInt.pack4bits(2, 2, 1, 1, 0, 0, 4, 1),
      PkgInt.pack4bits(5, 1, 6, 1, 5, 5, 4, 1),
      PkgInt.pack4bits(4, 1, 4, 4, 4, 1, 4, 1),
      PkgInt.pack4bits(4, 2, 0, 0, 0, 0, 0, 0)
   };
