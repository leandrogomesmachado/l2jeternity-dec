...
public class ArchiveFileObject implements JavaFileObject {
   ...
   public long getLastModified() {
      ...
      // 07: dup
      // 08: aload 0
      // 09: getfield org/eclipse/jdt/internal/compiler/tool/ArchiveFileObject.file Ljava/io/File;
      // 0c: invokespecial java/util/zip/ZipFile.<init> (Ljava/io/File;)V
      // 0f: astore 3
      // 10: aload 3
      // 11: aload 0
      // 12: getfield org/eclipse/jdt/internal/compiler/tool/ArchiveFileObject.entryName Ljava/lang/String;
