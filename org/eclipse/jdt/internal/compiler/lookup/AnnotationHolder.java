...
public class AnnotationHolder {
   ...
   static AnnotationHolder storeAnnotations(
      AnnotationBinding[] annotations, AnnotationBinding[][] parameterAnnotations, Object defaultValue, LookupEnvironment optionalEnv
   ) {
      ...
      if (defaultValue != null) {
         return new AnnotationHolder.AnnotationMethodHolder(annotations, parameterAnnotations, defaultValue, optionalEnv);
      } else {
         return (AnnotationHolder)(parameterAnnotations != null
            ? new AnnotationHolder.MethodHolder(annotations, parameterAnnotations)
            : new AnnotationHolder().setAnnotations(annotations));
      }
   }
