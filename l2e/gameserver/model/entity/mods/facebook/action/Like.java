...
public class Like implements FacebookAction {
   ...
   public boolean equals(Object obj) {
      return obj instanceof Like && this._profile.equals(((Like)obj)._profile) && this._fatherAction.equals(((Like)obj)._fatherAction);
   }
   ...
   public String toString() {
      return "Like{profile=" + this._profile + ", extractionDate=" + this._extractionDate + ", fatherAction=" + this._fatherAction + '}';
   }
}
