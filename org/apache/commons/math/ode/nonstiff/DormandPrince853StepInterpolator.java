   ...
   protected void computeInterpolatedStateAndDerivatives(double theta, double oneMinusThetaH) throws DerivativeException {
      if (!this.vectorsInitialized) {
         ...
         for(int i = 0; i < this.interpolatedState.length; ++i) {
            ...
            this.v[0][i] = 0.054293734116568765 * yDot1
               + 4.450312892752409 * yDot6
               + 1.8915178993145003 * yDot7
               + -5.801203960010585 * yDot8
               + 0.3111643669578199 * yDot9
               + -0.1521609496625161 * yDot10
               + 0.20136540080403034 * yDot11
               + 0.04471061572777259 * yDot12;
            this.v[1][i] = yDot1 - this.v[0][i];
            this.v[2][i] = this.v[0][i] - this.v[1][i] - this.yDotK[12][i];

            for(int k = 0; k < D.length; ++k) {
               this.v[k + 3][i] = D[k][0] * yDot1
                  + D[k][1] * yDot6
                  + D[k][2] * yDot7
                  + D[k][3] * yDot8
                  + D[k][4] * yDot9
         ...
         this.interpolatedState[i] = this.currentState[i]
            - oneMinusThetaH
               * (
                  this.v[0][i]
                     - theta
                        * (this.v[1][i] + theta * (this.v[2][i] + eta * (this.v[3][i] + theta * (this.v[4][i] + eta * (this.v[5][i] + theta * this.v[6][i])))))
               );
         this.interpolatedDerivatives[i] = this.v[0][i]
            + dot1 * this.v[1][i]
            + dot2 * this.v[2][i]
            + dot3 * this.v[3][i]
            + dot4 * this.v[4][i]
   ...
   protected void doFinalize() throws DerivativeException {
      if (this.currentState != null) {
         ...
         for(int j = 0; j < this.currentState.length; ++j) {
            double s = 0.0018737681664791894 * this.yDotK[0][j]
               + -4.450312892752409 * this.yDotK[5][j]
               + -1.6380176890978755 * this.yDotK[6][j]
               + 5.554964922539782 * this.yDotK[7][j]
               + -0.4353557902216363 * this.yDotK[8][j]
               + 0.30545274794128174 * this.yDotK[9][j]
               + -0.19316434850839564 * this.yDotK[10][j]
               + -0.03714271806722689 * this.yDotK[11][j]
               + -0.008298 * this.yDotK[12][j];
         ...
         for(int j = 0; j < this.currentState.length; ++j) {
            double s = -0.022459085953066622 * this.yDotK[0][j]
               + -4.422011983080043 * this.yDotK[5][j]
               + -1.8379759110070617 * this.yDotK[6][j]
               + 5.746280211439194 * this.yDotK[7][j]
               + -0.3111643669578199 * this.yDotK[8][j]
               + 0.1521609496625161 * this.yDotK[9][j]
               + -0.2014737481327276 * this.yDotK[10][j]
               + -0.04432804463693693 * this.yDotK[11][j]
               + -3.4046500868740456E-4 * this.yDotK[12][j]
               + 0.1413124436746325 * this.yDotKLast[0][j];
            yTmp[j] = this.currentState[j] + this.h * s;
         }
         ...
         for(int j = 0; j < this.currentState.length; ++j) {
            double s = -0.4831900357003607 * this.yDotK[0][j]
               + -9.147934308113573 * this.yDotK[5][j]
               + 5.791903296748099 * this.yDotK[6][j]
               + 9.870193778407696 * this.yDotK[7][j]
               + 0.04556282049746119 * this.yDotK[8][j]
               + 0.1521609496625161 * this.yDotK[9][j]
               + -0.20136540080403034 * this.yDotK[10][j]
               + -0.04471061572777259 * this.yDotK[11][j]
               + -0.0013990241651590145 * this.yDotK[12][j]
               + 2.9475147891527724 * this.yDotKLast[0][j]
               + -9.15095847217987 * this.yDotKLast[1][j];
            yTmp[j] = this.currentState[j] + this.h * s;
         }
