...
public class NewsAddress extends Address {
   ...
   public boolean equals(Object a) {
      if (!(a instanceof NewsAddress)) {
         ...
         return (this.newsgroup == null && s.newsgroup == null || this.newsgroup != null && this.newsgroup.equals(s.newsgroup))
            && (this.host == null && s.host == null || this.host != null && s.host != null && this.host.equalsIgnoreCase(s.host));
      }
   }
