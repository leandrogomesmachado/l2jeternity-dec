...
public class RIPEMD256Digest extends GeneralDigest {
   ...
   private final int F1(int var1, int var2, int var3, int var4, int var5, int var6) {
      return this.RL(var1 + this.f1(var2, var3, var4) + var5, var6);
   }

   private final int F2(int var1, int var2, int var3, int var4, int var5, int var6) {
      return this.RL(var1 + this.f2(var2, var3, var4) + var5 + 1518500249, var6);
   }

   private final int F3(int var1, int var2, int var3, int var4, int var5, int var6) {
      return this.RL(var1 + this.f3(var2, var3, var4) + var5 + 1859775393, var6);
   }

   private final int F4(int var1, int var2, int var3, int var4, int var5, int var6) {
      return this.RL(var1 + this.f4(var2, var3, var4) + var5 + -1894007588, var6);
   }

   private final int FF1(int var1, int var2, int var3, int var4, int var5, int var6) {
      return this.RL(var1 + this.f1(var2, var3, var4) + var5, var6);
   }

   private final int FF2(int var1, int var2, int var3, int var4, int var5, int var6) {
      return this.RL(var1 + this.f2(var2, var3, var4) + var5 + 1836072691, var6);
   }

   private final int FF3(int var1, int var2, int var3, int var4, int var5, int var6) {
      return this.RL(var1 + this.f3(var2, var3, var4) + var5 + 1548603684, var6);
   }

   private final int FF4(int var1, int var2, int var3, int var4, int var5, int var6) {
