...
class EscapeProcessor {
   ...
   public static final Object escapeSQL(
      String sql, TimeZone defaultTimeZone, boolean serverSupportsFractionalSecond, ExceptionInterceptor exceptionInterceptor
   ) throws SQLException {
                     ...
                     if (token.length() > 2) {
                        ...
                        if (nestedBrace != -1) {
                           ...
                           Object remainingResults = escapeSQL(
                              token.substring(1, token.length() - 1), defaultTimeZone, serverSupportsFractionalSecond, exceptionInterceptor
                           );
   ...
   private static void processTimestampToken(
      TimeZone tz, StringBuilder newSql, String token, boolean serverSupportsFractionalSecond, ExceptionInterceptor exceptionInterceptor
   ) throws SQLException {
      int startPos = token.indexOf(39) + 1;
      int endPos = token.lastIndexOf(39);
      if (startPos != -1 && endPos != -1) {
