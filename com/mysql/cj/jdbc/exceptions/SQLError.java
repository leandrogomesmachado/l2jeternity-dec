...
public class SQLError {
   ...
   public static SQLException createCommunicationsException(String message, Throwable underlyingException, ExceptionInterceptor interceptor) {
      ...
      SQLException var6 = new CommunicationsException(message, underlyingException);
      if (underlyingException != null) {
         try {
            var6.initCause(underlyingException);
         } catch (Throwable var5) {
         }
      }

      return runThroughExceptionInterceptor(interceptor, var6);
   }
