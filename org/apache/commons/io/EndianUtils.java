...
public class EndianUtils {
   ...
   public static long readSwappedLong(byte[] data, int offset) {
      long low = (long)(
         ((data[offset + 0] & 255) << 0) + ((data[offset + 1] & 255) << 8) + ((data[offset + 2] & 255) << 16) + ((data[offset + 3] & 255) << 24)
      );
      long high = (long)(
         ((data[offset + 4] & 255) << 0) + ((data[offset + 5] & 255) << 8) + ((data[offset + 6] & 255) << 16) + ((data[offset + 7] & 255) << 24)
      );
