...
public class URLName {
   ...
   protected void parseString(String url) {
      ...
      if (url.regionMatches(protocolEnd + 1, "//", 0, 2)) {
         ...
         if (fileStart != -1) {
            refStart = (int)url.substring(protocolEnd + 3, fileStart);
            if (fileStart + 1 < len) {
            ...
            refStart = (int)url.substring(protocolEnd + 3);
         }

         int i = refStart.indexOf(64);
         if (i != -1) {
            String fulluserpass = refStart.substring(0, i);
            refStart = (int)refStart.substring(i + 1);
         ...
         int portindex;
         if (refStart.length() > 0 && refStart.charAt(0) == '[') {
            portindex = refStart.indexOf(58, refStart.indexOf(93));
         } else {
            portindex = refStart.indexOf(58);
         }

         if (portindex != -1) {
            String portstring = refStart.substring(portindex + 1);
            ...
            this.host = refStart.substring(0, portindex);
         } else {
            this.host = refStart;
         }
