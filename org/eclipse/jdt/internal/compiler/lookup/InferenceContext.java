...
public class InferenceContext {
   ...
   public String toString() {
      ...
      for(int length = this.genericMethod.typeVariables.length; i < length; ++i) {
      ...
      for(int length = this.collectedSubstitutes == null ? 0 : this.collectedSubstitutes.length; i < length; ++i) {
      ...
      for(int length = this.substitutes == null ? 0 : this.substitutes.length; ix < length; ++ix) {
         if (this.substitutes[ix] != null) {
            ++i;
            buffer.append('{').append(this.genericMethod.typeVariables[ix].sourceName);
            buffer.append("=").append(this.substitutes[ix].shortReadableName()).append('}');
         }
      }
