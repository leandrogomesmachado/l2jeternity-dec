...
public class TCollections {
   ...
   public static TDoubleList unmodifiableList(TDoubleList list) {
      return (TDoubleList)(list instanceof RandomAccess ? new TUnmodifiableRandomAccessDoubleList(list) : new TUnmodifiableDoubleList(list));
   }

   public static TFloatList unmodifiableList(TFloatList list) {
      return (TFloatList)(list instanceof RandomAccess ? new TUnmodifiableRandomAccessFloatList(list) : new TUnmodifiableFloatList(list));
   }

   public static TIntList unmodifiableList(TIntList list) {
      return (TIntList)(list instanceof RandomAccess ? new TUnmodifiableRandomAccessIntList(list) : new TUnmodifiableIntList(list));
   }

   public static TLongList unmodifiableList(TLongList list) {
      return (TLongList)(list instanceof RandomAccess ? new TUnmodifiableRandomAccessLongList(list) : new TUnmodifiableLongList(list));
   }

   public static TByteList unmodifiableList(TByteList list) {
      return (TByteList)(list instanceof RandomAccess ? new TUnmodifiableRandomAccessByteList(list) : new TUnmodifiableByteList(list));
   }

   public static TShortList unmodifiableList(TShortList list) {
      return (TShortList)(list instanceof RandomAccess ? new TUnmodifiableRandomAccessShortList(list) : new TUnmodifiableShortList(list));
   }

   public static TCharList unmodifiableList(TCharList list) {
      return (TCharList)(list instanceof RandomAccess ? new TUnmodifiableRandomAccessCharList(list) : new TUnmodifiableCharList(list));
   }
   ...
   public static TDoubleList synchronizedList(TDoubleList list) {
      return (TDoubleList)(list instanceof RandomAccess ? new TSynchronizedRandomAccessDoubleList(list) : new TSynchronizedDoubleList(list));
   }

   static TDoubleList synchronizedList(TDoubleList list, Object mutex) {
      return (TDoubleList)(list instanceof RandomAccess ? new TSynchronizedRandomAccessDoubleList(list, mutex) : new TSynchronizedDoubleList(list, mutex));
   }

   public static TFloatList synchronizedList(TFloatList list) {
      return (TFloatList)(list instanceof RandomAccess ? new TSynchronizedRandomAccessFloatList(list) : new TSynchronizedFloatList(list));
   }

   static TFloatList synchronizedList(TFloatList list, Object mutex) {
      return (TFloatList)(list instanceof RandomAccess ? new TSynchronizedRandomAccessFloatList(list, mutex) : new TSynchronizedFloatList(list, mutex));
   }

   public static TIntList synchronizedList(TIntList list) {
      return (TIntList)(list instanceof RandomAccess ? new TSynchronizedRandomAccessIntList(list) : new TSynchronizedIntList(list));
   }

   static TIntList synchronizedList(TIntList list, Object mutex) {
      return (TIntList)(list instanceof RandomAccess ? new TSynchronizedRandomAccessIntList(list, mutex) : new TSynchronizedIntList(list, mutex));
   }

   public static TLongList synchronizedList(TLongList list) {
      return (TLongList)(list instanceof RandomAccess ? new TSynchronizedRandomAccessLongList(list) : new TSynchronizedLongList(list));
   }

   static TLongList synchronizedList(TLongList list, Object mutex) {
      return (TLongList)(list instanceof RandomAccess ? new TSynchronizedRandomAccessLongList(list, mutex) : new TSynchronizedLongList(list, mutex));
   }

   public static TByteList synchronizedList(TByteList list) {
      return (TByteList)(list instanceof RandomAccess ? new TSynchronizedRandomAccessByteList(list) : new TSynchronizedByteList(list));
   }

   static TByteList synchronizedList(TByteList list, Object mutex) {
      return (TByteList)(list instanceof RandomAccess ? new TSynchronizedRandomAccessByteList(list, mutex) : new TSynchronizedByteList(list, mutex));
   }

   public static TShortList synchronizedList(TShortList list) {
      return (TShortList)(list instanceof RandomAccess ? new TSynchronizedRandomAccessShortList(list) : new TSynchronizedShortList(list));
   }

   static TShortList synchronizedList(TShortList list, Object mutex) {
      return (TShortList)(list instanceof RandomAccess ? new TSynchronizedRandomAccessShortList(list, mutex) : new TSynchronizedShortList(list, mutex));
   }

   public static TCharList synchronizedList(TCharList list) {
      return (TCharList)(list instanceof RandomAccess ? new TSynchronizedRandomAccessCharList(list) : new TSynchronizedCharList(list));
   }

   static TCharList synchronizedList(TCharList list, Object mutex) {
      return (TCharList)(list instanceof RandomAccess ? new TSynchronizedRandomAccessCharList(list, mutex) : new TSynchronizedCharList(list, mutex));
   }
