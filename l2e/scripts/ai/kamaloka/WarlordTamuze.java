...
public class WarlordTamuze extends Fighter {
   ...
   protected void thinkAttack() {
      ...
      if (this.getAttackTarget() != null && this._spawnTimer + 60000L < System.currentTimeMillis()) {
         MonsterInstance follower = NpcUtils.spawnSingle(
            18576, Location.findPointToStay(actor.getLocation(), 600, actor.getGeoIndex(), true), actor.getReflectionId(), 0L
         );
