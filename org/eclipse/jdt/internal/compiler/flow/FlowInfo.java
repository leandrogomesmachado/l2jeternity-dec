...
public abstract class FlowInfo {
   ...
   public static UnconditionalFlowInfo mergedOptimizedBranches(
      FlowInfo initsWhenTrue, boolean isOptimizedTrue, FlowInfo initsWhenFalse, boolean isOptimizedFalse, boolean allowFakeDeadBranch
   ) {
   ...
   public static UnconditionalFlowInfo mergedOptimizedBranchesIfElse(
      ...
      if (isOptimizedTrue) {
         if (initsWhenTrue != DEAD_END || !allowFakeDeadBranch) {
            mergedInfo = initsWhenTrue.addPotentialInitializationsFrom(initsWhenFalse.nullInfoLessUnconditionalCopy()).unconditionalInits();
         } else if (!reportDeadCodeInKnownPattern) {
