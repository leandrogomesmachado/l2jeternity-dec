...
public class DormandPrince54Integrator extends EmbeddedRungeKuttaIntegrator {
   ...
   private static final double[] STATIC_B = new double[]{
      0.09114583333333333, 0.0, 0.44923629829290207, 0.6510416666666666, -0.322376179245283, 0.13095238095238096, 0.0
   };
   ...
   protected double estimateError(double[][] yDotK, double[] y0, double[] y1, double h) {
      ...
      for(int j = 0; j < this.mainSetDimension; ++j) {
         double errSum = 0.0012326388888888888 * yDotK[0][j]
            + -0.0042527702905061394 * yDotK[2][j]
            + 0.03697916666666667 * yDotK[3][j]
            + -0.05086379716981132 * yDotK[4][j]
            + 0.0419047619047619 * yDotK[5][j]
            + -0.025 * yDotK[6][j];
