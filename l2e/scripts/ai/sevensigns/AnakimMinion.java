...
public class AnakimMinion extends Fighter {
   private final int[] _enemies = new int[]{32717, 32716};
   ...
   protected void onEvtSpawn() {
      ...
      super.onEvtSpawn();
      ThreadPoolManager.getInstance().schedule(new AnakimMinion.Attack(), 3000L);
   }
   ...
   public class Attack implements Runnable {
      @Override
      public void run() {
         AnakimMinion.this.getActiveChar().setIsImmobilized(false);
      }
   }
}
