...
public class NestableDelegate implements Serializable {
   ...
   public String getMessage(int index) {
      ...
      return (class$org$apache$commons$lang$exception$Nestable == null
               ? (class$org$apache$commons$lang$exception$Nestable = class$("org.apache.commons.lang.exception.Nestable"))
               : class$org$apache$commons$lang$exception$Nestable)
            .isInstance(t)
         ? ((Nestable)t).getMessage(0)
         : t.getMessage();
   }
   ...
   public String[] getMessages() {
      ...
      for(int i = 0; i < throwables.length; ++i) {
         msgs[i] = (class$org$apache$commons$lang$exception$Nestable == null
                  ? (class$org$apache$commons$lang$exception$Nestable = class$("org.apache.commons.lang.exception.Nestable"))
                  : class$org$apache$commons$lang$exception$Nestable)
               .isInstance(throwables[i])
