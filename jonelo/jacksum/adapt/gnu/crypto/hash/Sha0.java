...
public class Sha0 extends BaseHash {
   ...
   public boolean selfTest() {
      if (valid == null) {
         ...
         valid = new Boolean("0164B8A914CD2A5E74C4F7FF082C4D97F1EDF880".equals(var2));
      }
   ...
   private static final synchronized int[] sha(int var0, int var1, int var2, int var3, int var4, byte[] var5, int var6) {
      ...
      for(int var17 = 16; var17 < 80; ++var17) {
         w[var17] = w[var17 - 3] ^ w[var17 - 8] ^ w[var17 - 14] ^ w[var17 - 16];
      }

      for(int var18 = 0; var18 < 20; ++var18) {
         int var13 = (var7 << 5 | var7 >>> 27) + (var8 & var9 | ~var8 & var10) + var11 + w[var18] + 1518500249;
         var11 = var10;
         var10 = var9;
         var9 = var8 << 30 | var8 >>> 2;
         var8 = var7;
      ...
      for(int var19 = 20; var19 < 40; ++var19) {
         int var22 = (var7 << 5 | var7 >>> 27) + (var8 ^ var9 ^ var10) + var11 + w[var19] + 1859775393;
         var11 = var10;
         var10 = var9;
         var9 = var8 << 30 | var8 >>> 2;
         var8 = var7;
      ...
      for(int var20 = 40; var20 < 60; ++var20) {
         int var23 = (var7 << 5 | var7 >>> 27) + (var8 & var9 | var8 & var10 | var9 & var10) + var11 + w[var20] + -1894007588;
         var11 = var10;
         var10 = var9;
         var9 = var8 << 30 | var8 >>> 2;
         var8 = var7;
      ...
      for(int var21 = 60; var21 < 80; ++var21) {
         int var24 = (var7 << 5 | var7 >>> 27) + (var8 ^ var9 ^ var10) + var11 + w[var21] + -899497514;
         var11 = var10;
         var10 = var9;
         var9 = var8 << 30 | var8 >>> 2;
         var8 = var7;
